...
from src.lasso.SSNAL.SuiteLasso.ClassicLasso.Classic_Lasso_python.Classic_Lasso_SSNAL import classic_lasso_ssnal
...
def test_ClassicLasso_random_wrapper(A,b,x0, alpha, max_iter, step_size, beta, newton_stepsize, tol, approx_sol):
    ...
    for crho in [1e-3]:
        ...
        obj, y, xi, x, info, runhist, x_history = classic_lasso_ssnal(Ainput, b, n, lam, opts)
        ...
        return x, runhist['primobj'], np.array(x_history)

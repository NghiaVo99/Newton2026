import numpy as np
import time
from src.lasso.SSNAL.SuiteLasso.ClassicLasso.Classic_Lasso_python.Classic_Lasso_SSNAL_main import *
...
def classic_lasso_ssnal(Ainput, b, n, lam, options, y=None, xi=None, x=None):
    ...
    obj_main, y, xi, x, info_main, runhist, x_history = Classic_Lasso_SSNAL_main(
    ...
    return [primobj, dualobj], y, xi, x, info, runhist, x_history

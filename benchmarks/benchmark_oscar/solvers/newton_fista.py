...
with safe_import_context() as import_ctx:
    ...
    from benchmark_utils.oscar_utils import compute_step_size
    from benchmark_utils.oscar_utils import run_newton_fista
...
class Solver(BaseSolver):
    ...
    def set_objective(self, X, y, alphas, fit_intercept):
        ...
        self.step_size = compute_step_size(X)

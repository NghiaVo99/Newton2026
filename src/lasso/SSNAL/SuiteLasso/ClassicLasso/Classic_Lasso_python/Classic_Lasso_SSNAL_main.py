import numpy as np
import time
from src.lasso.SSNAL.SuiteLasso.ClassicLasso.Classic_Lasso_python.Classic_Lasso_SSNCG import *
from src.lasso.SSNAL.SuiteLasso.ClassicLasso.Classic_Lasso_python.mexscale_wrapper import mexscale
from src.lasso.SSNAL.SuiteLasso.ClassicLasso.Classic_Lasso_python.mexsigma_update_wrapper import mexsigma_update_Classic_Lasso_SSNAL
...
def Classic_Lasso_SSNAL_main(Amap0, ATmap0, b, lam, parmain, y, xi, x):
    ...
    x_history = [np.linalg.norm(x-approx_sol)]  
    for it in range(1, maxiter + 1):
        ...
        # ytmp = info_NCG.get('ytmp', None)
        # print(">>> info_NCG['ytmp'] norm:", np.linalg.norm(ytmp))
        ...
        x_history.append(np.linalg.norm(x-approx_sol))
        print('TEST',x_history)
    ...
    return obj, y, xi, x, info, runhist, x_history
